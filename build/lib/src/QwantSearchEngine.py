...
class QwantSearchEngineService(SearchEngineService):
    '''Searches qwant.com'''
    def __init__(self, proxy=None, timeout=10):
        super(QwantSearchEngineService, self).__init__(proxy, timeout)
    ...
    def _get_url(self, tag, item='href'):
        ...
        return utils.unquote_url(tag.get(self._selectors('url'), u''))
